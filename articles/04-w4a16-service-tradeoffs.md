...
At N1024, median host rates are approximately **6,760 positions/s** for ANE and **27,300 positions/s** for GPU. ANE reaches **24.8%** of GPU speed. At N256 and above, ANE stays around 6,751–6,764 positions/s, indicating similar throughput across these request lengths under the fixed tile schedule. This does not determine whether a larger fused graph could run faster.
