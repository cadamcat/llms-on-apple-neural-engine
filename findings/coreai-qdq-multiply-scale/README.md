...
G7 rebuilt this MLP from the same codes and scales, without the RMS norm, in both Core ML and Core AI at 64 and 1024 positions. All eight W8A8 and A8W4 graphs miss the reference by <!-- claim:g7.mlp.a8.l2@g7-052 -->338–339%<!-- /claim --> on ordinary rows, and the W8A8 outputs are byte-identical between the two runtimes. The same product clamp was tested in <!-- claim:g7.mlp.clamp.configs@g7-110 -->4<!-- /claim --> configurations at <!-- claim:g7.mlp.clamp.positions@g7-111 -->64<!-- /claim --> positions, covering both A8 formats in both runtimes; <!-- claim:g7.mlp.clamp.l2@g7-053 -->5.6–5.8%<!-- /claim --> remains. [G7](../coreml-coreai-same-codes/#a8-graphs-of-the-full-mlp-fail-in-both-runtimes)
