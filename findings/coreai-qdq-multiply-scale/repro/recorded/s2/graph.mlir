module {
  coreai.graph @qdq_mul_scale_s2(%arg0: tensor<1x32x1x64xf16> {coreai.name = "x"}) -> (tensor<1x16x1x64xf16> {coreai.name = "dequantize_1"}) {
    ...
    %5 = coreai.constant dense<5.000000e-01> : tensor<f16>
