module {
  coreai.graph @qdq_mul_scale_s8_clip(%arg0: tensor<1x32x1x64xf16> {coreai.name = "x"}) -> (tensor<1x16x1x64xf16> {coreai.name = "dequantize_1"}) {
    %0 = coreai.constant dense<1.587500e+01> : tensor<f16>
    %1 = coreai.constant dense<-1.600000e+01> : tensor<f16>
    ...
    %7 = coreai.constant dense<1.250000e-01> : tensor<f16>
