module {
  coreai.graph @qdq_mul_scale_s2_clip(%arg0: tensor<1x32x1x64xf16> {coreai.name = "x"}) -> (tensor<1x16x1x64xf16> {coreai.name = "dequantize_1"}) {
    %0 = coreai.constant dense<6.350000e+01> : tensor<f16>
    %1 = coreai.constant dense<-6.400000e+01> : tensor<f16>
    ...
    %7 = coreai.constant dense<5.000000e-01> : tensor<f16>
